...
abstract class Expr {
  interface Visitor<R> {
    ...
    R visitTimeUnitsExpr(TimeUnits timeUnits);
  }
  ...
  static class River extends Expr {
    River(String name, String volume, Double flowRate, String riverType, String[] POIs) {
      this.name = name;
      this.volume = volume;
...
static class TimeUnits extends Expr {
  TimeUnits(String unit, Double numDays) {
    this.unit = unit;
    this.numDays = numDays;
      ...
      @Override
    <R> R accept(Visitor<R> visitor) {
      return visitor.visitTimeUnitsExpr(this);
    }
